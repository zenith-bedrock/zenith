...
public class TerrainProviderTests
{
    ...
    [Fact]
    public async Task Noise_spawn_radius_4_loads_81_columns()
    {
        ...
        // Warm up JIT/codegen so this correctness test exercises the same path as a join.
    ...
    public void Noise_surface_adjacent_steps_are_bounded()
    {
        ...
        Assert.True(
            ...
            $"adjacent surface step {maxStep} exceeds {OverworldTerrainSampler.MaxAdjacentSurfaceStep} (FastNoiseLite height)");
    }
