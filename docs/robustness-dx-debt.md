...
| Bedrock E2E CI | — | **Open — beta-hard**. Spike repo: [`zenith-bedrock/zenith-smoke-bot`](https://github.com/zenith-bedrock/zenith-smoke-bot) (Bun + bedrock-protocol, ADR §58) — join opt-in; not Zenith PR-blocking |
