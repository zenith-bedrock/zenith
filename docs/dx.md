...
20. Terrain gen (ADR §63–§66): `world.terrain: flat | noise`. Noise = overworld band, **worm caves**, **ore veins**, trees, ruins. Join/respawn = clear air via `SampleSpawnFeetY`. Existing `c:` blobs override config.
```
