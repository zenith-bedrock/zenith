...
[`phase-d-actor-pressure.md`](history/phases/phase-d-actor-pressure.md).
...
and the policy boundary are in [`phase-f-entity-interest.md`](history/phases/phase-f-entity-interest.md).
